...
export class RegisterComponent implements OnInit {
  ...
  agreement = "While creating a website account: i agree to abide by the company Name memebership agreemet-willing to receive related memeber ans service emails from company Name";
}